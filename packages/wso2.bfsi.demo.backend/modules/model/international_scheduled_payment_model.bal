...
# from the debtor account to a creditor for a single scheduled international payment.
...
public type InternationalScheduledPaymentData record {|
    ...
    # the debtor account to a creditor for a single scheduled international payment.
